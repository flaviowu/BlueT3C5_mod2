function mudarHumor1(){
    ...
    if (status === "19") {
        ...
        document.getElementById("taro").src="assets/img/ura_old.gif";
        ...
        document.getElementById("lenda6").scrollIntoView();
    }
    else if (status === "319") {
        document.getElementById("age").innerHTML = "19";
        document.getElementById("taro").src="assets/img/ura_young.gif";
